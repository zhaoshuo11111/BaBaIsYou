...
QT_MOC_LITERAL(1, 7, 5), // "sback"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 3), // "sok"
QT_MOC_LITERAL(4, 18, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(5, 42, 21) // "on_pushButton_clicked"

    },
    "search\0sback\0\0sok\0on_pushButton_2_clicked\0"
...
void search::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&search::sback)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (search::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&search::sok)) {
                *result = 1;
                return;
            }
        }
